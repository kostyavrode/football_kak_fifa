...
namespace Assets.FootballGameEngine_Indie.Scripts.States.Entities.PlayerStates.InFieldPlayerStates.ControlBall.SubStates
{
    public class ManualControl : BState
    {
        ...
        public override void Execute()
        {
            ...
            //capture input
            float horizontalRot = MobileInput.instance.GetAxisHorizontal();
            float verticalRot = -MobileInput.instance.GetAxisVertical();
            ...
            if (Input.GetButtonDown("LongPass") || MobileInput.instance.isLongPassButtonPressed)
            {
                ...
                MobileInput.instance.isLongPassButtonPressed = false;
            }
            else if (Input.GetButtonDown("ShortPass/Press") || MobileInput.instance.isPassButtonPressed)
            {
                // set the direction of movement
                Vector3 direction = Movement == Vector3.zero ? Owner.transform.forward : Movement;
                ...
                MobileInput.instance.isPassButtonPressed = false;
            }
            else if (Input.GetButtonDown("Shoot") || MobileInput.instance.isShootButtonPressed)
            {
                //fix shoot logic
                ...
                MobileInput.instance.isShootButtonPressed = false;
            }
            else
            {
