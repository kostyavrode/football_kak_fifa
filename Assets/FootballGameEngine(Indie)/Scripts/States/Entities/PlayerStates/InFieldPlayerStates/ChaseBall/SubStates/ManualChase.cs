...
namespace Assets.FootballGameEngine_Indie.Scripts.States.Entities.PlayerStates.InFieldPlayerStates.ChaseBall.SubStates
{
    public class ManualChase : BState
    {
        ...
        public override void Execute()
        {
            ...
            if(Input.GetButton("ShortPass/Press") || MobileInput.instance.isPassButtonPressed)
            {
                // set update logic
            ...
            else if(Input.GetButtonUp("ShortPass/Press") || MobileInput.instance.isPassButtonPressed)
            {
                // set update logic
                _updateLogic = false;
